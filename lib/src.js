...
<body>
  <main class="shell" aria-labelledby="callback-title">
    ...
    <section class="content">
      <p class="eyebrow" role="status"><span class="status-dot" aria-hidden="true"></span>${success ? "Callback verified" : "Callback rejected"}</p>
      <h1 id="callback-title">${success ? "Sign-in complete" : "Sign-in failed"}</h1>
